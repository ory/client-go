...
func (r ProjectAPICreateProjectApiKeyRequest) CreateProjectApiKeyBody(createProjectApiKeyBody CreateProjectApiKeyBody) ProjectAPICreateProjectApiKeyRequest {
	r.createProjectApiKeyBody = &createProjectApiKeyBody
	return r
}
...
func (a *ProjectAPIService) CreateProjectApiKeyExecute(r ProjectAPICreateProjectApiKeyRequest) (*ProjectApiKey, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.createProjectApiKeyBody
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
