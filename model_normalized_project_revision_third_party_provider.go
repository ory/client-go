...
type NormalizedProjectRevisionThirdPartyProvider struct {
	ApplePrivateKey *SQLNullString `json:"apple_private_key,omitempty"`
	...
	ClientSecret *SQLNullString `json:"client_secret,omitempty"`
...
// SetApplePrivateKey gets a reference to the given SQLNullString and assigns it to the ApplePrivateKey field.
...
// SetClientSecret gets a reference to the given SQLNullString and assigns it to the ClientSecret field.
