...
When calling this endpoint from a backend, please ensure to properly forward the HTTP cookies.
	...
	*/
	...
	GetIdentitySchemaExecute(r V0alpha2ApiGetIdentitySchemaRequest) (*IdentitySchema, *http.Response, error)
...
More information can be found at [Ory Kratos Email and Phone Verification Documentation](https://www.ory.sh/docs/kratos/self-service/flows/verify-email-account-activation).
	...
	*/
	...
	//  @return []IdentitySchema
	ListIdentitySchemasExecute(r V0alpha2ApiListIdentitySchemasRequest) ([]IdentitySchema, *http.Response, error)
...
func (r V0alpha2ApiGetIdentitySchemaRequest) Execute() (*IdentitySchema, *http.Response, error) {
...
// Execute executes the request
//  @return IdentitySchema
func (a *V0alpha2ApiService) GetIdentitySchemaExecute(r V0alpha2ApiGetIdentitySchemaRequest) (*IdentitySchema, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r V0alpha2ApiListIdentitySchemasRequest) Execute() ([]IdentitySchema, *http.Response, error) {
...
// Execute executes the request
//  @return []IdentitySchema
func (a *V0alpha2ApiService) ListIdentitySchemasExecute(r V0alpha2ApiListIdentitySchemasRequest) ([]IdentitySchema, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
