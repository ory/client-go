...
Learn how identities work in [Ory Kratos' User And Identity Model Documentation](https://www.ory.sh/docs/next/kratos/concepts/identity-user-model).
	...
	*/
	...
	/*
	CreateProjectApiToken # Create API Token

	Create an API token for a project.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param project The Project ID
	@return V0alpha2ApiCreateProjectApiTokenRequest
	*/
	CreateProjectApiToken(ctx context.Context, project string) V0alpha2ApiCreateProjectApiTokenRequest

	// CreateProjectApiTokenExecute executes the request
	//  @return ApiToken
	CreateProjectApiTokenExecute(r V0alpha2ApiCreateProjectApiTokenRequest) (*ApiToken, *http.Response, error)
...
When calling this endpoint from a backend, please ensure to properly forward the HTTP cookies.
	...
	*/
	...
	/*
	DeleteProjectApiToken # Delete API Token
	...
	@return V0alpha2ApiDeleteProjectApiTokenRequest
	*/
	DeleteProjectApiToken(ctx context.Context, project string, tokenId string) V0alpha2ApiDeleteProjectApiTokenRequest

	// DeleteProjectApiTokenExecute executes the request
	DeleteProjectApiTokenExecute(r V0alpha2ApiDeleteProjectApiTokenRequest) (*http.Response, error)
...
More information can be found at [Ory Kratos Email and Phone Verification Documentation](https://www.ory.sh/docs/kratos/self-service/flows/verify-email-account-activation).
	...
	*/
	...
	/*
	ListProjectApiTokens # List a Project's API Tokens

	A list of all the project's API tokens.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param project The Project ID
	@return V0alpha2ApiListProjectApiTokensRequest
	*/
	ListProjectApiTokens(ctx context.Context, project string) V0alpha2ApiListProjectApiTokensRequest

	// ListProjectApiTokensExecute executes the request
	//  @return []ApiToken
	ListProjectApiTokensExecute(r V0alpha2ApiListProjectApiTokensRequest) ([]ApiToken, *http.Response, error)
...
type V0alpha2ApiCreateProjectApiTokenRequest struct {
	ctx context.Context
	ApiService V0alpha2Api
	project string
	createProjectApiTokenRequest *CreateProjectApiTokenRequest
}

func (r V0alpha2ApiCreateProjectApiTokenRequest) CreateProjectApiTokenRequest(createProjectApiTokenRequest CreateProjectApiTokenRequest) V0alpha2ApiCreateProjectApiTokenRequest {
	r.createProjectApiTokenRequest = &createProjectApiTokenRequest
	return r
}

func (r V0alpha2ApiCreateProjectApiTokenRequest) Execute() (*ApiToken, *http.Response, error) {
...
Create an API token for a project.
 ...
 @return V0alpha2ApiCreateProjectApiTokenRequest
*/
func (a *V0alpha2ApiService) CreateProjectApiToken(ctx context.Context, project string) V0alpha2ApiCreateProjectApiTokenRequest {
	return V0alpha2ApiCreateProjectApiTokenRequest{
		ApiService: a,
		ctx: ctx,
		project: project,
...
// Execute executes the request
//  @return ApiToken
func (a *V0alpha2ApiService) CreateProjectApiTokenExecute(r V0alpha2ApiCreateProjectApiTokenRequest) (*ApiToken, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	// body params
	localVarPostBody = r.createProjectApiTokenRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type V0alpha2ApiDeleteProjectApiTokenRequest struct {
	ctx context.Context
	ApiService V0alpha2Api
	project string
	tokenId string
...
func (r V0alpha2ApiDeleteProjectApiTokenRequest) Execute() (*http.Response, error) {
...
Deletes an API Token and immediately removes it.
 ...
 @return V0alpha2ApiDeleteProjectApiTokenRequest
*/
func (a *V0alpha2ApiService) DeleteProjectApiToken(ctx context.Context, project string, tokenId string) V0alpha2ApiDeleteProjectApiTokenRequest {
	return V0alpha2ApiDeleteProjectApiTokenRequest{
		ApiService: a,
		ctx: ctx,
		project: project,
...
// Execute executes the request
func (a *V0alpha2ApiService) DeleteProjectApiTokenExecute(r V0alpha2ApiDeleteProjectApiTokenRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "V0alpha2ApiService.DeleteProjectApiToken")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type V0alpha2ApiListProjectApiTokensRequest struct {
	ctx context.Context
	ApiService V0alpha2Api
	project string
}

func (r V0alpha2ApiListProjectApiTokensRequest) Execute() ([]ApiToken, *http.Response, error) {
...
A list of all the project's API tokens.
 ...
 @return V0alpha2ApiListProjectApiTokensRequest
*/
func (a *V0alpha2ApiService) ListProjectApiTokens(ctx context.Context, project string) V0alpha2ApiListProjectApiTokensRequest {
	return V0alpha2ApiListProjectApiTokensRequest{
		ApiService: a,
		ctx: ctx,
		project: project,
...
// Execute executes the request
//  @return []ApiToken
func (a *V0alpha2ApiService) ListProjectApiTokensExecute(r V0alpha2ApiListProjectApiTokensRequest) ([]ApiToken, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
