...
func (o *EventStream) GetHttpsEndpoint() string {
	if o == nil || IsNil(o.HttpsEndpoint.Get()) {
		var ret string
		return ret
	}
	return *o.HttpsEndpoint.Get()
}
...
// SetHttpsEndpoint gets a reference to the given NullableString and assigns it to the HttpsEndpoint field.
func (o *EventStream) SetHttpsEndpoint(v string) {
	o.HttpsEndpoint.Set(&v)
}
// SetHttpsEndpointNil sets the value for HttpsEndpoint to be an explicit nil
func (o *EventStream) SetHttpsEndpointNil() {
	o.HttpsEndpoint.Set(nil)
}
