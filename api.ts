 ...
 * 
 * @export
 * @interface CreateProjectApiTokenRequest
 */
export interface CreateProjectApiTokenRequest {
    /**
     * The Token Name  A descriptive name for the token.  in: body
     * @type {string}
     * @memberof CreateProjectApiTokenRequest
     */
    'name': string;
}
/**
...
export interface NormalizedProjectRevision {
     ...
     * @memberof NormalizedProjectRevision
     */
    'hydra_oauth2_grant_jwt_max_ttl'?: string | null;
    /**
     ...
     * @memberof NormalizedProjectRevision
     */
    'hydra_ttl_access_token'?: string | null;
    /**
     * 
     * @type {string}
     * @memberof NormalizedProjectRevision
     */
    'hydra_ttl_auth_code'?: string | null;
    /**
     * 
     * @type {string}
     * @memberof NormalizedProjectRevision
     */
    'hydra_ttl_id_token'?: string | null;
    /**
     * 
     * @type {string}
     * @memberof NormalizedProjectRevision
     */
    'hydra_ttl_login_consent_request'?: string | null;
    /**
     * 
     * @type {string}
     * @memberof NormalizedProjectRevision
     */
    'hydra_ttl_refresh_token'?: string | null;
    /**
...
export const AdminApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {number} [limit] The maximum amount of consent sessions to be returned, upper bound is 500 sessions.
         * @param {number} [offset] The offset from where to start looking.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        listSubjectConsentSessions: async (subject: string, limit?: number, offset?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const AdminApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async listSubjectConsentSessions(subject: string, limit?: number, offset?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<PreviousConsentSession>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listSubjectConsentSessions(subject, limit, offset, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Use this endpoint to list all trusted JWT Bearer Grant Type Issuers.
...
export const AdminApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        listSubjectConsentSessions(subject: string, limit?: number, offset?: number, options?: any): AxiosPromise<Array<PreviousConsentSession>> {
            return localVarFp.listSubjectConsentSessions(subject, limit, offset, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to list all trusted JWT Bearer Grant Type Issuers.
         * @summary List Trusted OAuth2 JWT Bearer Grant Type Issuers
...
export class AdminApi extends BaseAPI {
     ...
     * @memberof AdminApi
     */
    public listSubjectConsentSessions(subject: string, limit?: number, offset?: number, options?: AxiosRequestConfig) {
        return AdminApiFp(this.configuration).listSubjectConsentSessions(subject, limit, offset, options).then((request) => request(this.axios, this.basePath));
    }
...
export const MetadataApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async isReady(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IsReady200Response>> {
...
export const MetadataApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        isReady(options?: any): AxiosPromise<IsReady200Response> {
 ...
 * @extends {BaseAPI}
 */
export class ReadApi extends BaseAPI {
    /**
     * To learn how relation tuples and the check works, head over to [the documentation](../concepts/relation-tuples.mdx).
     * @summary Check a relation tuple
     * @param {string} [namespace] Namespace of the Relation Tuple
...
export const V0alpha2ApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        adminPatchIdentity: async (id: string, jsonPatch?: Array<JsonPatch>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('adminPatchIdentity', 'id', id)
            const localVarPath = `/admin/identities/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @param {CreateProjectApiTokenRequest} [createProjectApiTokenRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createProjectApiToken: async (project: string, createProjectApiTokenRequest?: CreateProjectApiTokenRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'project' is not null or undefined
            assertParamExists('createProjectApiToken', 'project', project)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(createProjectApiTokenRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        deleteProjectApiToken: async (project: string, tokenId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'project' is not null or undefined
            assertParamExists('deleteProjectApiToken', 'project', project)
            // verify required parameter 'tokenId' is not null or undefined
            assertParamExists('deleteProjectApiToken', 'tokenId', tokenId)
         ...
         * @throws {RequiredError}
         */
        listProjectApiTokens: async (project: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'project' is not null or undefined
            assertParamExists('listProjectApiTokens', 'project', project)
            const localVarPath = `/projects/{project}/tokens`
                .replace(`{${"project"}}`, encodeURIComponent(String(project)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
...
export const V0alpha2ApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async adminPatchIdentity(id: string, jsonPatch?: Array<JsonPatch>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Identity>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.adminPatchIdentity(id, jsonPatch, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * This endpoint updates an identity. The full identity payload (except credentials) is expected. This endpoint does not support patching.  Learn how identities work in [Ory Kratos\' User And Identity Model Documentation](https://www.ory.sh/docs/next/kratos/concepts/identity-user-model).
         ...
         * @throws {RequiredError}
         */
        async createProjectApiToken(project: string, createProjectApiTokenRequest?: CreateProjectApiTokenRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiToken>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createProjectApiToken(project, createProjectApiTokenRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * This endpoint initializes a browser-based user logout flow and a URL which can be used to log out the user.  This endpoint is NOT INTENDED for API clients and only works with browsers (Chrome, Firefox, ...). For API clients you can call the `/self-service/logout/api` URL directly with the Ory Session Token.  The URL is only valid for the currently signed in user. If no user is signed in, this endpoint returns a 401 error.  When calling this endpoint from a backend, please ensure to properly forward the HTTP cookies.
         ...
         * @throws {RequiredError}
         */
        async deleteProjectApiToken(project: string, tokenId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteProjectApiToken(project, tokenId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get a JSON Schema
         ...
         * @throws {RequiredError}
         */
        async listProjectApiTokens(project: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ApiToken>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listProjectApiTokens(project, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Lists all projects you have access to.
...
export const V0alpha2ApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createProjectApiToken(project: string, createProjectApiTokenRequest?: CreateProjectApiTokenRequest, options?: any): AxiosPromise<ApiToken> {
            return localVarFp.createProjectApiToken(project, createProjectApiTokenRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * This endpoint initializes a browser-based user logout flow and a URL which can be used to log out the user.  This endpoint is NOT INTENDED for API clients and only works with browsers (Chrome, Firefox, ...). For API clients you can call the `/self-service/logout/api` URL directly with the Ory Session Token.  The URL is only valid for the currently signed in user. If no user is signed in, this endpoint returns a 401 error.  When calling this endpoint from a backend, please ensure to properly forward the HTTP cookies.
         * @summary Create a Logout URL for Browsers
         ...
         * @throws {RequiredError}
         */
        deleteProjectApiToken(project: string, tokenId: string, options?: any): AxiosPromise<void> {
            return localVarFp.deleteProjectApiToken(project, tokenId, options).then((request) => request(axios, basePath));
        },
        /**
         * Get a JSON Schema
         * @param {string} id ID must be set to the ID of schema you want to get
         ...
         * @throws {RequiredError}
         */
        listProjectApiTokens(project: string, options?: any): AxiosPromise<Array<ApiToken>> {
            return localVarFp.listProjectApiTokens(project, options).then((request) => request(axios, basePath));
        },
        /**
         * Lists all projects you have access to.
         * @summary # List All Projects
 ...
 * @extends {BaseAPI}
 */
export class V0alpha2Api extends BaseAPI {
    /**
     * This endpoint creates an identity. Learn how identities work in [Ory Kratos\' User And Identity Model Documentation](https://www.ory.sh/docs/next/kratos/concepts/identity-user-model).
     * @summary Create an Identity
     * @param {AdminCreateIdentityBody} [adminCreateIdentityBody] 
     ...
     * @memberof V0alpha2Api
     */
    public adminPatchIdentity(id: string, jsonPatch?: Array<JsonPatch>, options?: AxiosRequestConfig) {
        return V0alpha2ApiFp(this.configuration).adminPatchIdentity(id, jsonPatch, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof V0alpha2Api
     */
    public createProjectApiToken(project: string, createProjectApiTokenRequest?: CreateProjectApiTokenRequest, options?: AxiosRequestConfig) {
        return V0alpha2ApiFp(this.configuration).createProjectApiToken(project, createProjectApiTokenRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof V0alpha2Api
     */
    public deleteProjectApiToken(project: string, tokenId: string, options?: AxiosRequestConfig) {
        return V0alpha2ApiFp(this.configuration).deleteProjectApiToken(project, tokenId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getIdentitySchema(id: string, options?: AxiosRequestConfig) {
        return V0alpha2ApiFp(this.configuration).getIdentitySchema(id, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof V0alpha2Api
     */
    public listProjectApiTokens(project: string, options?: AxiosRequestConfig) {
        return V0alpha2ApiFp(this.configuration).listProjectApiTokens(project, options).then((request) => request(this.axios, this.basePath));
    }
